...
public class AuthController {
    ...
    public ResponseEntity<?> registerAdmin(@RequestBody SignUpDTO signUpDto) {
        ...
        return ResponseEntity.ok().body(Collections.singletonMap("message", "Admin registered successfully"));
    ...
    public ResponseEntity<?> registerSimpleUser(@RequestBody SignUpDTO signUpDto) {
        ...
        return ResponseEntity.ok().body(Collections.singletonMap("message", "Simple user registered successfully"));
    }
}