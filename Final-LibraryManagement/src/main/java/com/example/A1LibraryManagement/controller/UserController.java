...
/*    private void checkAuthentication() {
    ...
    public ResponseEntity<Object> deleteUser(@PathVariable String email){
        ...
        try{
            ...
            return ResponseEntity.badRequest().body(Collections.singletonMap("error", "Error deleting user: " + e.getMessage()));
        }
    }

    @PutMapping("/{email}")
    //@PreAuthorize("hasRole('SIMPLE_USER') or hasRole('ADMIN')")
    public ResponseEntity<Object> updateUser(@PathVariable String email, @RequestBody UserDTODetails updatedUser){
        CheckAuthentication checkAuthentication = new CheckAuthentication();
        checkAuthentication.checkAuthenticationRole("ADMIN");
        try{
            ...
            return ResponseEntity.badRequest().body(Collections.singletonMap("error", "Error updating user: " + e.getMessage()));
        }
    }
